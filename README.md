...
MP3のアルバムアート表示(ベースラインJPEG及びPNG)に対応しています。プログレッシブJPEGには対応していません。
...
* 0.9.0 (2023/03/06) ... PCM8A無しでのMP3再生に対応 060loadhighで動作しなくなっていたのを修正 アルバムアートがプログレッシブJPEGの際に警告を出すようにした PNGのアルバムアート表示改善
