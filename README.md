...
Mercury-Unit はMP3再生時に周波数ハーフモードを使用するため V3.5 以上が必要です。オプションでフル周波数再生も可能で、その場合においては V3.0/V3.1 でも大丈夫かもしれません。ただし 満開版 V4.0 での動作確認はしていません。(当方のエミュレータ環境だと V4.0 では pcm8pp.x が組み込めませんでした)
